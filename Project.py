...
def system():
    ...
    # Topframe
    topframe = Frame(root, bg="blue", width=100, height=50)
    topframe.pack(side=TOP)

    # Leftframe
    leftframe = Frame(root, width=500, height=400)
    ...
    totbtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Total", bg="black", fg="yellow", bd=3, padx=5, pady=5,
                    width=8, command=tottal).grid(row=6, column=3)

    resetbtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Reset", bg="Black", fg="yellow", bd=3, padx=5,
                      pady=5, width=10, command=reset).grid(row=4, column=3)

    exitbtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Exit The System", bg="Black", fg="yellow", bd=3, padx=5,
                     pady=5, width=12, command=exit).grid(row=6, column=2)

    addbtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Add", bg="Black", fg="yellow", bd=3, padx=5, pady=5,
                    width=10, command=add).grid(row=2, column=3)

    deletebtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Delete Record", bg="Black", fg="yellow", bd=3,
                       padx=5, pady=5, width=10, command=Delete).grid(row=4, column=2)

    ########################### feedback form ################################

    def feedbackk():
        feed = Tk()
        feed.geometry("400x500")
        ...
        lbl2 = Label(feed, font=("calisto MT", 15), text="We're glad you choose us ! Please tell us how it was!",
    ...
    # Feedbackbutton
    feedbtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Feedback Form", fg="Yellow", bg="black", bd=3, padx=10,
    ...
    # menubutton
    menubtn = Button(leftframe, font=('Calibri', 16, 'bold'), text="Menu Card", bg="black", fg="yellow", bd=3, padx=6,
                     pady=5, width=10, command=menu).grid(row=2, column=2)
